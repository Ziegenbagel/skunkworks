...
Rectangle {
    ...
    Dialog {
        ...
        contentItem: Column {
            ...
            Label { width: parent.width; text: "HABITABILITY SCORE · " + (root.selectedPlanet.habitabilityScore === null || root.selectedPlanet.habitabilityScore === undefined ? "UNKNOWN" : Number(root.selectedPlanet.habitabilityScore).toFixed(6)); color: Constants.textColor }
