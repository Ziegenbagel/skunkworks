# Skunkworks Asset Manifest

| Asset family | Location | Rights/provenance | Release action |
|---|---|---|---|
...
See `src/ui/assets/audio/AUDIO_LICENSES.md`,
`src/ui/assets/icons/README.md`, `THIRD_PARTY_NOTICES.md`, and
`docs/user-guide/assets/PRIVACY_REVIEW.md` for the detailed records.
