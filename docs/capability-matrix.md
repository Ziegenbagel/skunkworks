...
| Cargo and containers | Yes, including accessible sector storage and wreck caches | Move, jettison, recover, route, cache manually on Others mothership wrecks, and durable sector-storage transfer | Routing rules and logistics goals; no autonomous wreck caching | Reservation, destination, capacity, and idempotency validation |
...
Reviewed compatibility is API v103 through v139. A newer unreviewed server
