...
| Cargo and containers | Yes, including accessible sector storage | Move, jettison, recover, route, and durable sector-storage transfer | Routing rules and logistics goals | Reservation, destination, capacity, and idempotency validation |
...
Reviewed compatibility is API v103 through v135. A newer unreviewed server
